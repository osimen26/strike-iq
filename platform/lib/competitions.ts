...
export const COMPETITIONS: CompetitionConfig[] = [
  ...
  // Italy
  {
    ...
    tier: 'free',
    priority: 3,
    logo: 'https://upload.wikimedia.org/wikipedia/en/e/e1/Serie_A_logo_%282021%29.svg',
    active: true,
    syncEnabled: true,
    capabilities: ['odds', 'fixtures', 'h2h'],
  },
  ...
  // France
  {
    ...
    tier: 'free',
    priority: 5,
    logo: 'https://upload.wikimedia.org/wikipedia/en/c/c5/Ligue_1_logo.svg',
    active: true,
    syncEnabled: true,
    capabilities: ['odds', 'fixtures', 'h2h'],
  },
  ...
  },
  {
    ...
    tier: 'free',
    priority: 7,
    logo: 'https://upload.wikimedia.org/wikipedia/en/0/03/Europa_League_2024.svg',
    active: true,
    syncEnabled: true,
    capabilities: ['odds', 'fixtures', 'h2h'],
  },
  ...
  },
  {
    ...
    tier: 'free',
    priority: 11,
    logo: 'https://upload.wikimedia.org/wikipedia/en/5/5d/EuroLeague_logo.svg',
    active: true,
    syncEnabled: true,
    capabilities: ['odds', 'fixtures', 'h2h'],
  },
  ...
  // England — Second Tier
  {
    ...
    tier: 'pro',
    priority: 12,
    logo: 'https://upload.wikimedia.org/wikipedia/en/b/b1/EFL_Championship.svg',
    active: true,
    syncEnabled: false,
  ...
  // Spain — Second Tier
  {
    ...
    tier: 'pro',
    priority: 13,
    logo: 'https://upload.wikimedia.org/wikipedia/en/3/3e/LaLiga_Hypermotion_2023_logo.svg',
    active: true,
    syncEnabled: false,
    capabilities: ['odds', 'fixtures'],
  },
  ...
  // Italy — Second Tier
  {
    ...
    tier: 'pro',
    priority: 14,
    logo: 'https://upload.wikimedia.org/wikipedia/en/c/c7/Serie_B_%282023%29.svg',
    active: true,
    syncEnabled: false,
    capabilities: ['odds', 'fixtures'],
  },
  ...
  // Netherlands
  {
    ...
    tier: 'pro',
    priority: 17,
    logo: 'https://upload.wikimedia.org/wikipedia/en/3/34/Eredivisie_logo.svg',
    active: true,
    syncEnabled: false,
    capabilities: ['odds', 'fixtures'],
  },
  ...
  // Portugal
  {
    ...
    tier: 'pro',
    priority: 18,
    logo: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/Liga_Portugal_logo.svg',
    active: true,
    syncEnabled: false,
    capabilities: ['odds', 'fixtures'],
  },
  ...
  // Turkey
  {
    ...
    tier: 'pro',
    priority: 19,
    logo: 'https://upload.wikimedia.org/wikipedia/en/1/10/S%C3%BCper_Lig_logo.svg',
    active: true,
    syncEnabled: false,
    capabilities: ['odds', 'fixtures'],
  },
  ...
  // Belgium
  {
    ...
    tier: 'pro',
    priority: 20,
    logo: 'https://upload.wikimedia.org/wikipedia/en/1/1c/Belgian_Pro_League_logo.svg',
    active: true,
    syncEnabled: false,
    capabilities: ['odds', 'fixtures'],
  },
  ...
  // Scotland
  {
    ...
    tier: 'pro',
    priority: 21,
    logo: 'https://upload.wikimedia.org/wikipedia/en/3/39/Scottish_Premiership_logo.svg',
    active: true,
    syncEnabled: false,
    capabilities: ['odds', 'fixtures'],
  },
  ...
  // Greece
  {
    ...
    tier: 'pro',
    priority: 22,
    logo: 'https://upload.wikimedia.org/wikipedia/en/8/82/Super_League_Greece_logo.svg',
    active: true,
    syncEnabled: false,
    capabilities: ['odds', 'fixtures'],
  },
  ...
  // Saudi Arabia
  {
    ...
    tier: 'pro',
    priority: 24,
    logo: 'https://upload.wikimedia.org/wikipedia/en/b/b1/Saudi_Pro_League_logo.svg',
    active: true,
    syncEnabled: false,
    capabilities: ['odds', 'fixtures'],
  },
  ...
  // Europe — UEFA Conference League
  {
    ...
    tier: 'pro',
    priority: 25,
    logo: 'https://upload.wikimedia.org/wikipedia/en/d/dc/UEFA_Europa_Conference_League.svg',
    active: true,
    syncEnabled: false,
    capabilities: ['odds', 'fixtures'],
  },
  ...
  // Asia — AFC Champions League
  {
    ...
    tier: 'pro',
    priority: 26,
    logo: 'https://upload.wikimedia.org/wikipedia/en/f/f7/AFC_Champions_League_Elite_logo.svg',
    active: true,
    syncEnabled: false,
