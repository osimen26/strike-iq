  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-16">
      ...
      <div className="p-8 rounded-2xl bg-[#09090b] border border-zinc-800 relative overflow-hidden shadow-2xl">
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-primary-600/10 blur-3xl rounded-full translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
        ...
        <div className="relative z-10 space-y-8">
          <div className="flex flex-col md:flex-row justify-between items-start gap-4">
            ...
            <div className="text-left md:text-right bg-[#121215] px-5 py-3 rounded-xl border border-zinc-800 shrink-0">
              ...
              <p className="text-3xl font-bold text-primary-600 font-mono mt-0.5">{prediction.confidence}%</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 border-y border-zinc-800/80 py-6">
            <div className="bg-[#121215] p-4 rounded-xl border border-zinc-800/60">
              ...
              <p className="text-lg font-bold text-primary-600 font-mono mt-1">{prediction.selection}</p>
            </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-zinc-800/80">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {prediction.explanation.keyFactors.map((factor: any, idx: number) => (
                        <span key={idx} className="px-3 py-1 rounded-md text-xs font-mono font-bold bg-black/50 text-primary-600 border border-primary-600/30 uppercase tracking-wider">
                          {String(factor)}
                        </span>
                      ))}
                    </div>
