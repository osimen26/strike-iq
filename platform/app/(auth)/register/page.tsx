    ...
    <div className="w-full flex flex-col gap-8 font-main text-white">
      ...
      {verificationSent ? (
        <div
          role="status"
          aria-live="polite"
          className="bg-emerald-950/40 border border-primary-600 p-6 rounded-xl text-center flex flex-col gap-3 my-4 shadow-[0_0_25px_rgba(19,133,97,0.15)]"
        >
          <div className="w-12 h-12 bg-primary-600/20 text-primary-600 rounded-full flex items-center justify-center mx-auto text-2xl font-bold" aria-hidden="true">
            📧
          </div>
          <h2 className="text-white font-bold text-lg">Verification Email Sent!</h2>
          <p className="text-gray-300 text-sm leading-relaxed">
            We sent a secure activation link to <span className="text-primary-600 font-semibold">{email}</span>. Please check your inbox and click the link to activate your VIP account before logging in.
          </p>
          <Link
            href="/login"
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-5 w-full" noValidate>
          ...
          <div className="flex flex-col sm:flex-row w-full gap-4">
            <div className="flex flex-col gap-2 flex-1">
              ...
              <input
                ...
                className="w-full bg-background-glass border border-border-glass rounded-lg px-4 py-3 text-white text-sm placeholder:text-zinc-600 outline-none focus:border-primary-600 focus:ring-1 focus:ring-primary-600 transition-colors"
                placeholder="eg. John"
              />
            </div>
            <div className="flex flex-col gap-2 flex-1">
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <input
              ...
              className="w-full bg-background-glass border border-border-glass rounded-lg px-4 py-3 text-white text-sm uppercase font-mono tracking-wider placeholder:text-zinc-600 outline-none focus:border-primary-600 focus:ring-1 focus:ring-primary-600 transition-colors"
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <div className="relative w-full">
              <input
                ...
                className="w-full bg-background-glass border border-border-glass rounded-lg pl-4 pr-12 py-3 text-white text-sm placeholder:text-zinc-600 outline-none focus:border-primary-600 focus:ring-1 focus:ring-primary-600 transition-colors"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary-600 text-white font-semibold text-[16px] py-3.5 rounded-lg hover:bg-[#0f6b4d] transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-2 shadow-[0_0_15px_rgba(19,133,97,0.3)]"
          >
