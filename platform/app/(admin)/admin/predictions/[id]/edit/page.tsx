  ...
  return (
    <div className="max-w-4xl mx-auto pb-12">
      <div className="mb-8">
        ...
        <p className="text-zinc-400 mt-2">Update prediction details, publish outcome status, or manage VIP slip codes.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="bg-[#121215] border-zinc-800 rounded-xl">
        ...
        <Card className="bg-[#121215] border-primary-600/40 rounded-xl">
          <CardContent className="p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pt-3 border-t border-zinc-800/80">
              ...
              <Button
                ...
                className="px-4 py-5 bg-primary-600 hover:bg-[#0f6b4d] text-white text-xs font-bold font-mono uppercase tracking-wider rounded-lg transition-all shadow-[0_0_15px_rgba(19,133,97,0.3)] disabled:opacity-50 shrink-0 flex items-center gap-1.5"
              >
                <ZapIcon size={14} />
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {["High EV", "Pro Pick", "Value Bet", "Bankroll Builder", "Top 5 Leagues Lock", "UCL Lock"].map((tag) => (
                    <Button
                      ...
                      className="text-xs bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white px-2.5 py-1 rounded border-zinc-700 h-auto"
                    >
                      + {tag}
                    </Button>
                  ))}
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
          <Button 
            ...
            className="flex-1 w-full py-6 bg-primary-600 hover:bg-primary-500 text-white font-bold rounded-xl transition-colors disabled:opacity-50 text-lg shadow-[0_0_20px_rgba(33,205,141,0.2)]"
          >
          ...
          <Button
            ...
            disabled={loading || deleting}
            className="w-full sm:w-auto px-8 py-6 bg-red-500/15 hover:bg-red-500/25 border-red-500/40 text-red-400 hover:text-red-300 font-bold rounded-xl transition-colors disabled:opacity-50 text-lg flex items-center justify-center gap-2"
          >
            <TrashIcon size={18} />
