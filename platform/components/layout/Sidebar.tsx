      ...
      `}>
        <div className="p-6 flex items-center justify-between border-b border-zinc-900">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-primary-600 rounded-md flex items-center justify-center font-bold text-white shadow-sm">
              <ZapIcon size={18} className="text-white" />
            </div>
            <span className="text-xl font-heading text-white tracking-wider uppercase font-bold">Strike<span className="text-primary-600">IQ</span></span>
          </div>
            ...
            return (
              <Link
                ...
                className={`flex items-center space-x-3 px-3.5 py-2.5 rounded-xl transition-all font-mono text-sm ${
                  isActive
                    ? "bg-primary-600/15 text-[#00FF88] border border-primary-600/50 font-bold shadow-[0_0_15px_rgba(0,255,136,0.15)]"
