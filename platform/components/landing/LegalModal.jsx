...
export default function LegalModal({ isOpen, onClose, type }) {
  ...
  const content = {
    terms: (
      <div className="space-y-8">
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">1. Acceptance of Terms</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">4. Acceptable Use and Account Termination</h2>
          <p className="text-zinc-400 leading-relaxed text-[15px]">
        ...
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">5. Limitation of Liability</h2>
          <p className="text-zinc-400 leading-relaxed text-[15px]">
    ...
    privacy: (
      <div className="space-y-8">
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">1. Information We Collect</h2>
          <p className="text-zinc-400 leading-relaxed text-[15px]">
        ...
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">2. How We Use Your Information</h2>
          <p className="text-zinc-400 leading-relaxed text-[15px]">
        ...
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">3. Third-Party Services</h2>
          <p className="text-zinc-400 leading-relaxed text-[15px]">
        ...
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">4. Data Security</h2>
          <p className="text-zinc-400 leading-relaxed text-[15px]">
        ...
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">5. Your Rights</h2>
          <p className="text-zinc-400 leading-relaxed text-[15px]">
    ...
    cookies: (
      <div className="space-y-8">
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">1. What Are Cookies?</h2>
          <p className="text-zinc-400 leading-relaxed text-[15px]">
        ...
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">2. How We Use Cookies</h2>
          <ul className="list-disc pl-5 space-y-2 text-zinc-400 text-[15px] leading-relaxed">
            <li>
              <strong className="text-zinc-200 font-medium">Essential Cookies:</strong> These are required to operate our platform, such as keeping you authenticated in the dashboard and securely processing your subscriptions.
            </li>
            <li>
              <strong className="text-zinc-200 font-medium">Functionality Cookies:</strong> We use these to remember your preferences (like regional currency formatting) to provide a localized experience.
            </li>
            <li>
              <strong className="text-zinc-200 font-medium">Analytics & Performance Cookies:</strong> These allow us to recognize and count the number of visitors and see how they move around the site, helping us improve our UI and performance.
            </li>
          </ul>
        </section>

        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">3. Third-Party Cookies</h2>
          <p className="text-zinc-400 leading-relaxed text-[15px]">
        ...
        <section className="space-y-3">
          <h2 className="text-[17px] font-semibold text-zinc-100">4. Managing Your Cookies</h2>
          <p className="text-zinc-400 leading-relaxed text-[15px]">
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6" style={{ fontFamily: 'var(--font-main)' }}>
      ...
      <div className="relative w-full max-w-2xl bg-[#09090b] border border-zinc-800/80 shadow-[0_0_50px_-12px_rgba(0,0,0,0.8)] rounded-2xl overflow-hidden max-h-[85vh] flex flex-col z-10 ring-1 ring-white/5">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-zinc-800/50 bg-[#09090b]/80 backdrop-blur-md z-20">
          ...
          <button 
            onClick={onClose}
            className="w-8 h-8 flex items-center justify-center rounded-full bg-zinc-800/50 text-zinc-400 hover:text-white hover:bg-zinc-700 transition-colors"
          >
        ...
        <div className="h-8 bg-gradient-to-t from-[#09090b] to-transparent absolute bottom-0 left-0 right-0 pointer-events-none" />
      </div>
    </div>
  );
}
