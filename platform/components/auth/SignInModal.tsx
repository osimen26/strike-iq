      ...
      <div className="relative w-full max-w-md bg-[#09090b] border border-zinc-800 rounded-xl p-6 md:p-8 z-10 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link
            ...
            className="w-full py-3 px-4 rounded-xl font-bold text-sm bg-primary-600 hover:bg-[#0f6b4d] text-white transition-all text-center flex items-center justify-center gap-2"
          >
            <ZapIcon size={16} />
