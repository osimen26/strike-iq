            ...
            >
              <div className="flex flex-wrap gap-1.5 mb-0.5">
                ...
                {match.isProPick && !match.isFreePick && (
                  <span className="px-2 py-0.5 rounded bg-primary-600/15 border border-primary-600/30 text-[9px] font-mono font-bold text-primary-600 uppercase tracking-wider whitespace-nowrap flex items-center gap-1">
              ...
              {match.bookingCode && (
                ...
                >
                  <span className="text-[10px] font-mono font-bold text-zinc-300 uppercase tracking-wider flex items-center gap-1.5">
                    <TicketIcon
                      size={14}
                      className={match.isFreePick ? "text-cyan-400" : "text-primary-600"}
                    />{" "}
                  ...
                  <span
                    className={`font-mono font-bold text-xs tracking-widest select-all bg-black/40 px-2 py-0.5 rounded border ${
                      copied
                        ...
                        : "text-white border-zinc-800 group-hover/code:border-primary-600"
                    }`}
                  >
                    {isBlurred
                  ...
                  <span
                    className={`text-[10px] transition-colors flex items-center gap-1 font-bold ${
                      copied
                        ...
                        : "text-primary-600 group-hover/code:text-white"
                    }`}
                  >
